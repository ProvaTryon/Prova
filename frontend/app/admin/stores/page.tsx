  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-serif text-3xl font-semibold mb-2">Store Management</h1>
          <p className="text-muted-foreground">Manage all stores and store owners on the platform</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-green-700 font-medium">Active Stores</p>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
              statusFilter === "pending" ? "bg-primary text-primary-foreground" : "bg-muted hover:bg-muted/80"
            }`}
          >
            Pending
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
              statusFilter === "suspended" ? "bg-primary text-primary-foreground" : "bg-muted hover:bg-muted/80"
            }`}
          >
            Suspended
          </button>
